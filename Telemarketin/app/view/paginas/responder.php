...
HTML;
                                    ...
                                    <tr>
                                <form action="../../controller/respostaUsuario.php" method="POST">
                                <td>
                                    <label>ID da Solicitação: </label>
                                    <input  type="text" name="id" value="<?php echo "$id";?>"/>
                                    <label>Descrição: </label>
                                    <textarea cols="30" rows="30" type="text" name="descricao" value=""><?php echo "$descricao";?></textarea>
