            ...
            <div class="base-central">
                ...
                <nav class="menu">
                    <ul>
                        ...
                        <li><a href="loginAtendente.php">Login de Atendente</a></li>
                        <li><a href="novoUsuario.php">Novo Usuario</a></li>
                    </ul>
                </nav>
                ...
                <div class="base-home">
                    ...
                    <div class="base-formulario">
                        <form action="../../controller/registraAtendente.php" method="POST">
                            <label>Nome</label>
